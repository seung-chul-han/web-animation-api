!(function () {
  ...
  var T = (function () {
    function e(e) {
      u.set(this, { source: null, orientation: 'block', scrollOffsets: [], animations: [], scrollOffsetFns: [] }),
      ...
      t(e, [
        ...
        },
        {
          ...
          get: function () {
            ...
            if (this.source != document.scrollingElement && ('visible' == e.overflow || 'clip' == e.overflow))
              return 'inactive';
        ...
        t(n, [
          ...
          },
          {
            ...
            get: function () {
              ...
              if (e != document.scrollingElement && ('visible' == t.overflow || 'clip' == t.overflow))
                return 'inactive';
    ...
    if (e.timeline) {
      ...
      if (i && null != e.startTime && !e.proxy.pending) {
        ...
        r > 0 && i >= a
          ...
          : 0 != r && (t && null !== e.holdTime && (e.startTime = A(e, e.holdTime)), (e.holdTime = null));
      }
      U(e),
        ...
        'finished' == e.proxy.playState
          ...
          : (e.finishedPromise && 'resolved' == e.finishedPromise.state && (e.finishedPromise = new E()),
  ...
  var _ = new WeakMap(),
        ...
        (n.cancel = function () {
          ...
          e.timeline
            ? ('idle' != this.playState &&
                ((function (e) {
                  e.pendingTask &&
                    ((e.pendingTask = null), O(e), e.readyPromise.reject(P()), x(e), e.readyPromise.resolve(e.proxy));
                })(e),
                e.finishedPromise && 'pending' == e.finishedPromise.state && e.finishedPromise.reject(P()),
        ...
        t(e, [
                        ...
                        i = {
                          apply: function (n) {
                            ...
                            if (e.timeline) {
                              ...
                              i.duration = r
                                ? CSS.percent(
                                    (100 * (i.iterations ? (r - i.delay - i.endDelay) / i.iterations : 0)) / r
                                  )
                                : CSS.percent(0);
                              var a = e.timeline.phase,
                                o = i.fill;
                              'before' == a && 'backwards' != o && 'both' != o && (i.progress = null),
                            ...
                            return (
                              (null !== a.duration && 'auto' !== a.duration) ||
                                (e.timeline &&
                                  ((a.delay = 0),
                                  (a.endDelay = 0),
                                  (a.duration = a.iterations ? (a.iterations ? 1e5 : 0) / a.iterations : 0),
                                  n.apply(t, [a]))),
          ...
          },
          {
            ...
            get: function () {
              var e = _.get(this);
              return e.timeline
                ? (e.readyPromise || ((e.readyPromise = new E()), e.readyPromise.resolve(this)), e.readyPromise.promise)
                : e.animation.ready;
            },
          },
        ]),
        ...
        t(e, [
          {
            ...
            set: function (e) {
              if (!(e instanceof Element))
                throw ((H.get(this).target = null), Error('Intersection target must be an element.'));
              H.get(this).target = e;
            },
          },
          {
    ...
    B = {
      ...
      OFFSET_WITH_SUFFIX: new RegExp(
        '(^[0-9]+)(' +
          ['em', 'ex', 'ch', 'rem', 'vw', 'vh', 'vmin', 'vmax', 'cm', 'mm', 'q', 'in', 'pc', 'pt', 'px', '%'].join(
            '|'
          ) +
          ')'
      ),
    ...
    K = new ((function () {
      ...
      return (
        ...
        (t.parseScrollTimeline = function (e) {
          ...
          for (
            var i = { name: n, source: 'auto', orientation: void 0, 'scroll-offsets': void 0 };
            '}' !== this.peek(e);
                ...
                (a &&
                  this.extractMatches(e.block.contents, B.ANIMATION).forEach(function (i) {
                    ...
                    r && l.push(r),
                      a &&
                        (o.push(a),
                        (e.block.contents = e.block.contents.replace(a, ' '.repeat(a.length))),
    ...
    (c.push({
      ...
      evaluate: function (e, t, n, i) {
        ...
        for (
          ...
          l.push('percent' == (r = o[s])[1] ? (r[0] * (s % 2 == 0 ? a.height : a.width)) / 100 : r[0]);
        var u = a.left - l[3],
                      ...
                      if ('none' == t);
                        ...
                        for (
                                  ...
                                  return (function (e) {
                                    ...
                                    return i && document.getElementById(i[1])
                                      ? n(
                                          ...
                                          i.length >= 3 ? { edge: i[2] } : {},
                                          i.length >= 4 ? { threshold: parseFloat(i[3]) } : {}
                                        )
                                      : null;
                                  })(e);
                                })
                          ...
                          if (
                            ...
                            ('none' == window.getComputedStyle(l.target, null).display || !X(l.target, e))
                          )
                            return null;
                        }
